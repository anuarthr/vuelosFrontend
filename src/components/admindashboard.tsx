  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const reservationsResponse = await axios.get('http://localhost:8081/api/v1/reservas', config);
        const airlinesResponse = await axios.get('http://localhost:8081/api/v1/aerolineas', config);
